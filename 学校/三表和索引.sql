...
#普通索引
ALTER TABLE student ADD INDEX putong(phone);

#组合索引
ALTER TABLE student ADD INDEX zuhe(phone,sex);

#全文索引，只能给字符类型添加		
ALTER TABLE student ADD FULLTEXT quanwen(phone,sex);

#删除索引
ALTER TABLE student DROP INDEX putong;